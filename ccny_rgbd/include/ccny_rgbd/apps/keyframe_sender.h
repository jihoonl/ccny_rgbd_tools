...
#ifndef CCNY_RGBD_KEYFRAME_SENDER_H
#define CCNY_RGBD_KEYFRAME_SENDER_H
...
class KeyframeSender
{
  public:
     ...
     */  
	KeyframeSender(const ros::NodeHandle& nh,
                   const ros::NodeHandle& nh_private);
    
    /** @brief Default destructor
     */
    virtual ~KeyframeSender();
...
#endif // CCNY_RGBD_KEYFRAME_SENDER_H
