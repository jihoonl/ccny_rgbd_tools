...
typedef dynamic_reconfigure::Server<FastDetectorConfig> FastDetectorConfigServer;
typedef boost::shared_ptr<FastDetectorConfigServer> FastDetectorConfigServerPtr;
